...
export function OrdersModal() {
  const { state, closeModal, placeOrders } = useSimulation();
  ...
  if (state.activeModal !== "orders") return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-zinc-200 border-2 border-zinc-400 shadow-lg w-full max-w-2xl mx-4 max-h-[80vh] flex flex-col">
        {/* Title Bar */}
        <div className="bg-gradient-to-b from-blue-200 to-blue-300 border-b border-zinc-400 px-3 py-1.5 flex items-center justify-between flex-shrink-0">
